                ...
                <div class="p-6">
                    <form action="{{ route('admin.products.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="col-span-1">
                                ...
                                <select name="category" id="category"
                                    ...
                                    <option value="cat-food" {{ old('category') == 'cat-food' ? 'selected' : '' }}>Cat
                                        Food</option>
                                    <option value="dog-food" {{ old('category') == 'dog-food' ? 'selected' : '' }}>Dog
                                        Food</option>
                                    <option value="pet-essentials" {{ old('category') == 'pet-essentials' ? 'selected' : '' }}>Pet Essentials</option>
                            ...
                            <div class="col-span-2">
                                ...
                                <textarea name="description" id="description" rows="4"
                                    class="mt-1 block w-full border-gray-300 focus:border-brand focus:ring-brand rounded-md shadow-sm">{{ old('description') }}</textarea>
                        ...
                        <div class="mt-8 flex justify-end space-x-4">
                            ...
                            <button type="submit"
                                class="px-4 py-2 bg-brand text-white rounded-md hover:bg-brand-dark transition-colors uppercase tracking-widest text-xs font-semibold shadow-md active:shadow-inner">Create
                                Product</button>
                        </div>
                    </form>
                </div>
